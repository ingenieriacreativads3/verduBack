...
import ObjInterface from '../../../Domain/Entities/Provider/Interface'
import Serviceable from '../../../Domain/Entities/Provider/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/provider'
	...
	@inject(TYPES.Validable) @named(TYPES.Provider) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Provider) private schema: Schemable
	@inject(TYPES.ProviderServiceableDomain) private service: Serviceable
