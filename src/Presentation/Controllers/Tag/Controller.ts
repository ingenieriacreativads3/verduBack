...
import ObjInterface from '../../../Domain/Entities/Tag/Interface'
import Serviceable from '../../../Domain/Entities/Tag/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Tag) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Tag) private schema: Schemable
	@inject(TYPES.TagServiceableDomain) private service: Serviceable
