...
import ObjInterface from '../../../Domain/Entities/PaymentMethod/Interface'
import Serviceable from '../../../Domain/Entities/PaymentMethod/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/paymentMethod'
	...
	@inject(TYPES.Validable) @named(TYPES.PaymentMethod) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.PaymentMethod) private schema: Schemable
	@inject(TYPES.PaymentMethodServiceableDomain) private service: Serviceable
