...
import ObjInterface from '../../../Domain/Entities/Bank/Interface'
import Serviceable from '../../../Domain/Entities/Bank/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/bank'
	...
	@inject(TYPES.Validable) @named(TYPES.Bank) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Bank) private schema: Schemable
	@inject(TYPES.BankServiceableDomain) private service: Serviceable
