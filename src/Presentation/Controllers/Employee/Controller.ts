...
import ObjInterface from '../../../Domain/Entities/Employee/Interface'
import Serviceable from '../../../Domain/Entities/Employee/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Employee) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Employee) private schema: Schemable
	@inject(TYPES.EmployeeServiceableDomain) private service: Serviceable
